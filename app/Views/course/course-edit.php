...
<div class="py-6">
    <div class="bg-tileBackground shadow-smooth rounded-lg p-6 mb-4">
        ...
        <form id="add-course-form" action="/course/update" method="post" enctype="multipart/form-data" class="flex flex-col gap-5">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="coursetitle" id="coursetitle" value="<?=$course->coursetitle?>" required>
            </div>
            <div class="mb-4">
                <label for="coursecontent" class="block text-sm font-medium text-gray-700">Content</label>
                <div id="editor" class="mt-1"></div>
                <input type="hidden" name="coursecontent" id="coursecontent" value='<?=$course->coursecontent?>'>
            </div>
            <div class="mb-4">
                ...
                <input type="file" name="assets[]" id="assets" class="hidden" multiple value="">
                <div class="mt-2 text-sm text-gray-700" id="file-names">
                    <?php
